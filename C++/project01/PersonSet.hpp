...
#ifndef __project01__PersonSet__
#define __project01__PersonSet__
...
public://成员函数
    ...
    Person& next();//遍历
    void reset();//复位
    void query(PersonSet& set);
    void queryN(PersonSet& set);
    void queryE(PersonSet& set);
};
#endif /* defined(__project01__PersonSet__) */
